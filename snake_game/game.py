...
class Game:
    def __init__(self):
        ...
        self.render = Render(self.background_img, self.screen, self.snake_head_img, self.snake_body_img, self.food_img,
                             self.bonus_img, self.poison_img, self.slow_img, self.tile_img, self.bush_img)
