...
class Render:
    def __init__(self, background_img, screen, snake_head_img, snake_body_img, food_img, bonus_img, poison_img,
                 slow_img, tile_img, bush_img):
        self.screen = screen
    ...
    def draw_background(self):
        ...
        for y in range(0, config.HEIGHT, bush_height):
            ...
            self.screen.blit(self.bush_right, (config.WIDTH - bush_width, y - bush_height),
                             (0, 0, bush_width, bush_height))
